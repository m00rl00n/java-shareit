...
public class ItemRequestController {
    ...
    @GetMapping("/all")
    ResponseEntity<Object> getAllRequests(@RequestHeader("X-Sharer-User-Id") Integer userId,
    ...
    ResponseEntity<Object> getRequestById(@RequestHeader("X-Sharer-User-Id") Integer userId,
